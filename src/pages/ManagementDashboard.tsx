...
export default function ManagementDashboard() {
 ...
 const viewText = { current: { label: 'viewCurrent', question: 'questionCurrent', date: 'registerDates', meaning: 'dateCurrentMeaning' }, period: { label: 'viewPeriod', question: 'questionPeriod', date: 'recordDates', meaning: 'datePeriodMeaning' }, cohort: { label: 'viewCohort', question: 'questionCohort', date: 'registerDates', meaning: 'dateCohortMeaning' }, payments: { label: 'viewPayments', question: 'questionPayments', date: 'paidDate', meaning: 'datePaymentsMeaning' } } as const
