...
export function validateAudience(a:Audience):string[]{return [...(!a.countries.length?['请选择国家。']:[]),...(!a.platforms.length?['请选择终端。']:[]),...(a.versions&&!versionRangeExists(a.versions)?['App 版本条件无效或范围没有交集，请检查版本号及上下界。']:[]),...(a.platforms.some(p=>!devicePlatforms.some(d=>d.value===p))?['请选择具体手机或 Pad 终端，旧配置需要重新确认设备范围。']:[])]}
