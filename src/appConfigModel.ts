import { clone, makeId, newPlan, templates, validVersion, versionMatches } from './abTestConfig'
...
export type UnitContent = { copy: Record<string, string>; details: PageDetails; translations: Plan['translations']; pageTranslations: Plan['pageTranslations']; steps?: string[] }
...
export function validateAudience(a:Audience):string[]{return [...(!a.countries.length?['请选择国家。']:[]),...(!a.platforms.length?['请选择终端。']:[])]}
...
export function audienceOverlap(a:Audience,b:Audience){return intersection(a.countries,b.countries,true)&&intersection(a.platforms,b.platforms)&&intersection(a.cities,b.cities)&&intersection(a.channels,b.channels)}
