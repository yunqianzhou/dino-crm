...
const words = {
 ...
 subtitle: ['查看整体跟进情况，按 CC 或日期查看同一组指标，并进入对应用户处理。', 'Review sales activity, compare the same metrics by CC or date, and open each user to take action.'],
 ...
 periodTotal: ['期间去重人数', 'Distinct users in period'], currentTotal: ['全部所选线索', 'All selected leads'],
